...
hl.bind(
    ...
    hl.dsp.exec_cmd("omarchy-hyprland-window-gaps-toggle"),
...
hl.bind(
    "SUPER + CTRL + COMMA",
    hl.dsp.exec_cmd("omarchy-toggle-notification-silencing"),
...
hl.bind(
    "SUPER + CTRL + Delete",
    hl.dsp.exec_cmd("omarchy-hyprland-monitor-internal toggle"),
    { description = "Toggle laptop display" }
)
hl.bind(
    "SUPER + CTRL + ALT + Delete",
    hl.dsp.exec_cmd("omarchy-hyprland-monitor-internal-mirror toggle"),
...
hl.bind(
    "SUPER + CTRL + PRINT",
    hl.dsp.exec_cmd("omarchy-capture-text-extraction"),
...
hl.bind(
    "SUPER + CTRL + ALT + T",
    hl.dsp.exec_cmd('notify-send -u low "    $(date +"%A %H:%M  ·  %d %B %Y  ·  Week %V")"'),
    { description = "Show time" }
)
hl.bind(
    "SUPER + CTRL + ALT + B",
    hl.dsp.exec_cmd('notify-send -u low "$(omarchy-battery-status)"'),
    { description = "Show battery remaining" }
)
hl.bind(
    "SUPER + CTRL + ALT + W",
    hl.dsp.exec_cmd('notify-send -u low "$(omarchy-weather-status)"'),
